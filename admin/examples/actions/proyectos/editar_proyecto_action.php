            ...
            if($estado_proyecto > 0){
                if(isset($fecha_inicio) && !empty($fecha_inicio)){
                    if(isset($id_cliente) && !empty($id_cliente)){
                        if($id_cliente > 0){
                            if(editarPoryecto($nombre_proyecto,$estado_proyecto,$fecha_inicio,$fecha_termino,$id_cliente,$comentario,$id_proyecto)){
                                echo 'Se ha editado el proyecto correctamente';
                            }else{
                                echo 'Error al editar en la base de datos';
                            }
