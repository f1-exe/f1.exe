...
class PDF_F1PUNTOEXE extends FPDF
{
// private variables
var $colonnes;
var $format;
...
function addPageNumber( $page )
{
	...
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5, $y1+3 );
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,5,utf8_decode("PÁGINA"), 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5, $y1 + 9 );
	$this->SetFont( "Arial", "", 10);
...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "Boleta de honorarios", 0, 0, "C");
...
function addCadreEurosFrancs2($sub_total,$total)
{
	$r1  = $this->w - 70;
	$r2  = $r1 + 60;
	$y1  = $this->h - 45;
	...
	$this->Cell(20,4, "$ ".$sub_total, 0, 0, "C");

	// $this->SetXY( $r1, $y1+10 );
	// $this->Cell(20,4, "10 %", 0, 0, "C");
...
function addCadreEurosFrancs3($sub_total,$total_sin_boleta)
{
	$r1  = $this->w - 70;
	$r2  = $r1 + 60;
	$y1  = $this->h - 45;
	...
	$this->SetXY( $r1+40, $y1+10 );
	$this->Cell(20,4, "$ ".$total_sin_boleta, 0, 0, "C");
}
