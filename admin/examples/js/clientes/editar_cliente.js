$("#btn_guardar").click(function (e) {
    ...
    $.ajax({
        url: 'actions/clientes/editar_cliente_action.php',
        type: 'POST',
        data: dataForm,
        success: function (data) {
            if(data === "Se ha editado el cliente correctamente"){
                MensajeFinal(data+", Espere mientras es redirigido a la vista de clientes");
