$("#btn_guardar").click(function (e) {
    ...
    $.ajax({
        url: 'actions/proyectos/agregar_proyecto_action.php',
        type: 'POST',
        data: dataForm,
        success: function (data) {
            if(data === "Se ha creado el proyecto correctamente"){
                document.getElementById("form_proyecto").reset();
                MensajeFinal(data+", Puede continuar agregando proyectos o ir a la lista de clientes creados");
            }else{
