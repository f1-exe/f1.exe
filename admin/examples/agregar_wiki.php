...
<body>
                        ...
                        <div class="card bg-secondary shadow">
                          ...
                          <div class="card-body">
                            <form id="form_wiki" name="form_wiki" method="POST" enctype="multipart/form-data" action="">
                              <h6 class="heading-small text-muted mb-4">información de la wiki</h6>
                              <div class="pl-lg-4">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label class="form-control-label">Seleccione cliente</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tema" id="tema" class="form-control form-control-alternative" placeholder="Cuentas de correo">
                                        </div>
                                    </div>
  ...
  <script src="js/wiki/agregar_wiki.js"></script>
  <!--CK EDITOR JS-->
  <script>
